...
const notificationSchema = {
  ...
  'pedestrian_stop': NotificationSchemaItem('Światła dla przechodniów', Icons.traffic_outlined, true),
  'bus_departures': NotificationSchemaItem('Odjazdy autobusów', Icons.directions_bus, false),
  'park_and_go': NotificationSchemaItem('Parkuj i jedź', Icons.local_parking, false),
  // 'warnings': NotificationSchemaItem('Ostrzeżenia', Icons.warning, true),
};
